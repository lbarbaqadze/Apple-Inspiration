...
export default function ApplePencilPage() {
  return (
      ...
      <section className="py-10 md:py-14 max-w-[1200px] mx-auto px-4 sm:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          ...
          <div className="bg-white p-6 sm:p-8 md:p-10 rounded-[1.8rem] flex flex-col justify-between min-h-[240px] sm:min-h-[280px] md:h-[320px] shadow-sm">
            <div>
              <h3 className="text-xl md:text-2xl font-semibold mb-1.5 text-neutral-900">Squeeze</h3>
              <p className="text-neutral-500 text-sm md:text-base leading-relaxed">
                Apple Pencil Pro can sense when you squeeze it and brings up a new palette, so you can quickly switch tools, line weights, and colors.
              </p>
            </div>
          ...
          <div className="bg-white p-6 sm:p-8 md:p-10 rounded-[1.8rem] flex flex-col justify-between min-h-[240px] sm:min-h-[280px] md:h-[320px] shadow-sm">
            <div>
              <h3 className="text-xl md:text-2xl font-semibold mb-1.5 text-neutral-900">Barrel Roll</h3>
              <p className="text-neutral-500 text-sm md:text-base leading-relaxed">
                A new gyroscope allows you to rotate Apple Pencil Pro to change orientation of shaped pen and brush tools, just like pen and paper.
              </p>
            </div>
